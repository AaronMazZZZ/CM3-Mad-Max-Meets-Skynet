...
"""autogenerated by genpy from racecarDepth/ObsPose.msg. Do not edit."""
import sys
...
class ObsPose(genpy.Message):
  _md5sum = "7e77b1edb72076900365c7711a9bdb5d"
  _type = "racecarDepth/ObsPose"
...
string frame_id
"""
  __slots__ = ['header','x','y','dist','angle']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObsPose, self).__init__(*args, **kwds)
